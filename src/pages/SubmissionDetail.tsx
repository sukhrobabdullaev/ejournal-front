  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        const message =
          (error.detail || error.message) || 'Failed to submit manuscript';
        setError(message);
        return;
      }
            ...
            <div className="flex items-center gap-3">
              ...
              {submission.status === 'draft' && (
                <button
                  ...
                  disabled={submitting}
                  className="px-4 py-2 bg-blue-600 text-white text-xs font-semibold hover:bg-blue-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
                >
