          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Link
                  to="/submit"
                  className="inline-flex items-center text-base font-semibold transition-all shadow-md"
                  style={{ 
                    padding: '12px 18px',
                ...
                <Link
                  ...
                  onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'rgba(11, 28, 77, 0.06)'}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p 
              ...
              style={{ color: '#475569' }}
            >
              Join a growing community of researchers and practitioners advancing 
              the frontiers of digital innovation and emerging technologies
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p 
                ...
                style={{ color: '#475569' }}
              >
                All articles are freely accessible to readers worldwide, maximizing 
            ...
            <div className="text-center">
              ...
              <p 
                ...
                style={{ color: '#475569' }}
              >
                Double-blind peer review process ensures quality and fairness in 
            ...
            <div className="text-center">
              ...
              <p 
                ...
                style={{ color: '#475569' }}
              >
                Guidance from leading experts in digital innovation and emerging 
                technologies
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p 
                ...
                style={{ color: '#475569' }}
              >
                Efficient review and publication process to get your research 
                published quickly
              </p>
            </div>
          </div>
      ...
      >
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 text-white text-opacity-90">
            Submit your manuscript today and contribute to the advancement of 
            digital innovation and emerging technologies
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              to="/submit"
              className="inline-flex items-center text-lg font-semibold transition-all shadow-lg"
              style={{ 
                padding: '12px 24px',
