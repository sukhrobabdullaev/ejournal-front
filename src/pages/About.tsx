  ...
  const values = [
    {
      ...
      title: 'Quality First',
      description:
        'Rigorous peer review and high editorial standards ensure every publication contributes meaningfully to the field.',
    },
    {
      icon: Zap,
      title: 'Speed & Efficiency',
      description:
        'Modern workflows and dedicated editorial team deliver fast decisions without compromising thoroughness.',
    },
    {
      icon: Users,
      title: 'Community Driven',
      description:
        'Built by researchers, for researchers. We listen to our community and continuously improve.',
    },
    {
      icon: Award,
      title: 'Open & Transparent',
      description:
        'Open access publishing, transparent review process, and clear policies make research accessible to all.',
    },
  ];
      ...
      >
        ...
        >
          ...
          <div className="space-y-4 text-base" style={{ color: '#475569', lineHeight: '1.7' }}>
            ...
            <p>
              Our focus on Digital Innovation and Emerging Technologies represents our commitment to
              being the <em>next</em> generation of academic journals—one that embraces technology
              not just as our subject matter, but as the foundation of our operations. From
              submission to publication, every step is optimized for efficiency while maintaining
              the highest standards of peer review.
            </p>
            <p>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    Receive feedback on their work in days, not months
                  </span>
                </li>
                <li className="flex items-start">
                  <span
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    Track their submission status in real-time with full transparency
                  </span>
                </li>
                <li className="flex items-start">
                  <span
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    Share their findings with a global audience without paywalls
                  </span>
                </li>
                <li className="flex items-start">
                  <span
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    Trust that review processes are fair, rigorous, and constructive
                  </span>
                </li>
                <li className="flex items-start">
                  <span
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    Contribute to a community that values both excellence and efficiency
                  </span>
                </li>
              </ul>
            </div>
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              >
                <span
                  className="mr-3 animate-pulse rounded-full"
                  style={{ width: '12px', height: '12px', backgroundColor: '#10B981' }}
                ></span>
                Current Focus (2026)
              </h3>
              <ul className="ml-6 space-y-3">
                <li className="flex items-start">
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    <strong>MVP Launch:</strong> Establish core publishing infrastructure and
                    onboard inaugural editorial board
                  </span>
                </li>
                <li className="flex items-start">
                  <span
                ...
                <li className="flex items-start">
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    <strong>Community Building:</strong> Engage with computing research community
                    and recruit reviewers
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="ml-6 space-y-3">
                <li className="flex items-start">
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    <strong>DOI Automation:</strong> Integrate with CrossRef for automatic DOI
                    assignment
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    <strong>DOAJ Indexing:</strong> Apply for inclusion in Directory of Open Access
                    Journals
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    <strong>Author Dashboard:</strong> Launch dashboard for tracking submissions and
                    revisions
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    <strong>Reviewer Portal:</strong> Build streamlined review interface with
                    automated reminders
                  </span>
                </li>
              </ul>
            ...
            <div>
              ...
              >
                <span
                  className="mr-3 rounded-full"
                  style={{ width: '12px', height: '12px', backgroundColor: '#2563EB' }}
                ></span>
              ...
              <ul className="ml-6 space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    <strong>Analytics Dashboard:</strong> Provide authors with article metrics and
                    citation tracking
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    <strong>Mobile App:</strong> Launch companion app for on-the-go manuscript
                    management
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    <strong>AI-Assisted Tools:</strong> Implement AI tools for plagiarism detection
            ...
            <div>
              ...
              >
                <span
                  className="mr-3 rounded-full"
                  style={{ width: '12px', height: '12px', backgroundColor: '#9333EA' }}
                ></span>
              ...
              <ul className="ml-6 space-y-3">
                <li className="flex items-start">
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    <strong>Web of Science:</strong> Achieve Web of Science indexing for maximum
                    visibility
                  </span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    <strong>Specialized Tracks:</strong> Introduce focused tracks for emerging
                    subfields
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  ></span>
                  <span style={{ color: '#475569', lineHeight: '1.7' }}>
                    <strong>Global Reach:</strong> Establish editorial offices in multiple
                    continents
                  </span>
                </li>
              </ul>
            ...
            {milestones.map((milestone, index) => (
              <div
                ...
                style={{
                  ...
                  border:
                    milestone.status === 'current' ? '2px solid #2563EB' : '1px solid #E2E8F0',
                }}
              >
                <div
                ...
                >
                  <span className="text-center text-sm font-bold">{milestone.year}</span>
                </div>
        ...
        >
          <h2 className="mb-4 text-3xl font-bold" style={{ color: '#FFFFFF' }}>
            Join Our Journey
          </h2>
          <p
            className="mx-auto mb-6 max-w-2xl text-xl"
            style={{ color: 'rgba(255, 255, 255, 0.9)' }}
          >
            Be part of the next generation of academic publishing. Submit your research, join our
            editorial board, or become a reviewer.
          </p>
