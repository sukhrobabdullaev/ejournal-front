            ...
            {tabs.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-center text-sm">{tab.label}</span>
                </button>
              );
            })}
          </div>
          ...
          <div style={{ padding: '32px' }}>
                ...
                <div>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      ...
                      ></span>
                      <div>
                        <p className="mb-1 font-semibold" style={{ color: '#0B1C4D' }}>
                          Originality & Plagiarism
                        </p>
                        <p className="text-sm" style={{ color: '#475569', lineHeight: '1.7' }}>
                          Authors must ensure their work is entirely original. Proper citation is
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm" style={{ color: '#475569', lineHeight: '1.7' }}>
                          Research data must be accurate and authentic. Fabrication or falsification
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm" style={{ color: '#475569', lineHeight: '1.7' }}>
                          Manuscripts under review should not be submitted to other journals
                          simultaneously.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm" style={{ color: '#475569', lineHeight: '1.7' }}>
                          All listed authors must have made substantial contributions. All
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm" style={{ color: '#475569', lineHeight: '1.7' }}>
                          If significant errors are discovered post-publication, authors must notify
                          the editor promptly.
                        </p>
                      </div>
                    </li>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm" style={{ color: '#475569', lineHeight: '1.7' }}>
                          Manuscripts are evaluated solely on merit, regardless of author
                          characteristics.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm" style={{ color: '#475569', lineHeight: '1.7' }}>
                          Editors must maintain confidentiality of all submitted manuscripts and
                          reviewer identities.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm" style={{ color: '#475569', lineHeight: '1.7' }}>
                          Editors must address ethical concerns and misconduct allegations promptly
                          and fairly.
                        </p>
                      </div>
                    </li>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm" style={{ color: '#475569', lineHeight: '1.7' }}>
                          Reviewers should only accept manuscripts in their area of expertise and
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm" style={{ color: '#475569', lineHeight: '1.7' }}>
                          Reviews should be constructive, objective, and free from personal
                          criticism.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm" style={{ color: '#475569', lineHeight: '1.7' }}>
                          Reviewers must not share or use information from manuscripts under review.
                        </p>
                      </div>
                    </li>
                  </ul>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="mb-4" style={{ color: '#475569', lineHeight: '1.7' }}>
                    ...
                    anonymous. This minimizes bias and ensures manuscripts are evaluated solely on
                    merit.
                  </p>
                  <div
                    style={{
                ...
                <div>
                  <h3 className="mb-6 text-xl font-semibold" style={{ color: '#0B1C4D' }}>
                  ...
                  <div className="space-y-5">
                    {[
                      {
                        num: 1,
                        title: 'Initial Screening (1-3 days)',
                        desc: 'Editorial office checks formatting, completeness, and basic fit with journal scope.',
                      },
                      {
                        num: 2,
                        title: 'Editorial Assessment (7-14 days)',
                        desc: 'Editor-in-Chief or Associate Editor evaluates scientific quality and novelty.',
                      },
                      {
                        num: 3,
                        title: 'Reviewer Assignment (3-5 days)',
                        desc: '2-3 expert reviewers are identified and invited based on their expertise.',
                      },
                      {
                        num: 4,
                        title: 'Peer Review (4-6 weeks)',
                        desc: 'Reviewers provide detailed feedback on methodology, results, and contribution.',
                      },
                      {
                        num: 5,
                        title: 'Editorial Decision (3-5 days)',
                        desc: 'Editor synthesizes reviewer feedback and makes final decision.',
                      },
                    ].map((step) => (
                    ...
                    {[
                      {
                        color: '#10B981',
                        title: 'Accept',
                        desc: 'Manuscript accepted for publication with minor editorial changes.',
                      },
                      {
                        color: '#F59E0B',
                        title: 'Minor Revision',
                        desc: 'Small changes required; typically does not require re-review.',
                      },
                      {
                        color: '#EF4444',
                        title: 'Major Revision',
                        desc: 'Significant improvements needed; manuscript sent back to reviewers after revision.',
                      },
                      {
                        color: '#DC2626',
                        title: 'Reject',
                        desc: 'Manuscript does not meet quality standards or journal scope.',
                      },
                    ].map((decision, idx) => (
            ...
            {activeTab === 'access' && (
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="mb-4" style={{ color: '#475569', lineHeight: '1.7' }}>
                    Under our open access policy, readers are free to:
                  </p>
                  <ul className="space-y-3">
                    {[
                      {
                        title: 'Read',
                        desc: 'Access full-text articles without subscription or payment barriers.',
                      },
                      {
                        title: 'Download',
                        desc: 'Save and store articles for personal or educational use.',
                      },
                      {
                        title: 'Share',
                        desc: 'Distribute articles to colleagues, students, and the public.',
                      },
                      {
                        title: 'Reuse',
                        desc: 'Adapt and build upon the work for any purpose, including commercial, with proper attribution.',
                      },
                    ].map((right, idx) => (
                      <li key={idx} className="flex items-start">
                        <span
                ...
                <div>
                  ...
                  >
                    <p className="mb-2 font-semibold" style={{ color: '#1E3A8A' }}>
                      MVP Phase: No APCs
                    </p>
                    ...
                    <p className="text-sm" style={{ color: '#1E40AF', lineHeight: '1.7' }}>
                      <strong>Future Sustainability:</strong> As the journal matures, we may
                      introduce a transparent APC structure to support operations. Authors will be
                      notified well in advance of any changes, and waivers will be available for
            ...
            {activeTab === 'plagiarism' && (
              <div className="space-y-8">
                ...
                >
                  <h3 className="mb-3 text-xl font-semibold" style={{ color: '#991B1B' }}>
                    Zero Tolerance Policy
                  </h3>
                  <p style={{ color: '#7F1D1D', lineHeight: '1.7' }}>
                    Manuscripts found to contain plagiarism will be immediately rejected. Authors
                    who submit plagiarized work may be banned from future submissions and reported
                    to their institutions. Published articles discovered to contain plagiarism will
                    be retracted.
                  </p>
                </div>
                    ...
                    {[
                      {
                        ...
                        desc: 'Copying text word-for-word from another source without quotation marks or citation.',
                      },
                      {
                        title: 'Paraphrasing Plagiarism',
                        desc: "Rewording someone else's ideas without proper attribution, even if the text is changed.",
                      },
                      {
                        title: 'Self-Plagiarism',
                        desc: "Reusing significant portions of one's own previously published work without proper citation.",
                      },
                      {
                        title: 'Mosaic Plagiarism',
                        desc: 'Borrowing phrases or ideas from multiple sources and weaving them together without attribution.',
                      },
                      {
                        title: 'Data Plagiarism',
                        desc: "Using someone else's data, figures, or images without proper permission and citation.",
                      },
                    ].map((type, idx) => (
                      <div key={idx}>
                        <p className="mb-1 font-semibold" style={{ color: '#0B1C4D' }}>
                ...
                <div>
                  ...
                  <p className="mb-4" style={{ color: '#475569', lineHeight: '1.7' }}>
                    All submitted manuscripts are screened for plagiarism using industry-standard
                    detection software. Manuscripts with significant similarity to existing work are
                    flagged for editorial review.
                  </p>
                  <p style={{ color: '#475569', lineHeight: '1.7' }}>
                    While some overlap is acceptable for common terminology and standard methodology
                    descriptions, manuscripts with substantial copying will be rejected or returned
                    for revision.
                  </p>
                </div>
